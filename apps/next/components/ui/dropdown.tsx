  ...
  return (
    <Headless.MenuItems
      ...
      className={cn(
        ...
        // Transitions
        "data-closed:data-leave:opacity-0 data-leave:duration-100 data-leave:ease-in transition",
      )}
    />
  );
}
...
>) {
  return (
    <Headless.Description
      ...
      className={cn(
        className,
        "group-data-focus:text-white forced-colors:group-data-focus:text-[HighlightText] col-span-2 col-start-2 row-start-2 text-sm/5 text-zinc-500 sm:text-xs/5",
      )}
    />
  );
}
